				...
				<div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
					<div className="flex flex-col w-full md:w-2/5 justify-center items-center md:items-start text-center md:text-left">
						...
						<div className="flex justify-between items-start text-center w-64">
							<Link
								to="/register"
								className="mx-auto lg:mx-0 hover:text-primary bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
							>
								Register
							</Link>
							<Link
